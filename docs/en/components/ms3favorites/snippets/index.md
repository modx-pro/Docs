...
title: Snippets
---
# ms3Favorites snippets

The component provides nine snippets for the favorites block, button, counter, page, and frontend lexicon.

- [ms3Favorites](ms3Favorites) — output list of products/resources by given IDs
...
- [ms3FavoritesPage](ms3FavoritesPage) — `/wishlist/` page with tabs and pagination
...
- [ms3fLexiconScript](ms3fLexiconScript) — lexicon and config for JS. Load **before** `favorites.js`

---
title: SvelteKit
description: SvelteKit server load and proxy to mxHeadless
---
...
Pass `event.fetch` so SvelteKit tracks the request during SSR.
...
- [Repository](https://github.com/Ibochkarev/mxHeadless/blob/main/docs/examples/sveltekit.md)

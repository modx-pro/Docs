...
* To show the generated password on the activation page, use the uncached
  **PasswordReset** result and output `extended.temp_password`. This is the
  temporary password generated by SendIt, not the MODX password hash.

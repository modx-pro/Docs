...
items: [
  ...
  { text: 'System settings', link: 'settings' },
  {
    ...
    items: [
      ...
      { text: 'Chart builder', link: 'interface/builder' },
      { text: 'Tops and flops', link: 'interface/topflops' },
  ...
  },
  {
    ...
    items: [
      { text: 'Metrics and indicators', link: 'metrics-and-charts/metrics' },
      { text: 'Filters and period', link: 'metrics-and-charts/filters' },
      { text: 'Chart types', link: 'metrics-and-charts/chart-types' },
      { text: 'Data sources', link: 'metrics-and-charts/data-sources' },
    ],
  },

...
MODX namespace: `easyfavicon`. The System Settings button on the component page opens them already filtered to EasyFavicon.
...
| `easyfavicon.auto_inject_profile` | — | Profile name or id for auto injection; empty means the active profile of the context |
...
| `easyfavicon.interactive_url` | `https://realfavicongenerator.net/api/favicon_generator` | RealFaviconGenerator interactive API address; no need to change it |

...
Component for authorization via social and other services.

Main benefit: direct integration with services and the ability to link multiple services to one MODX user account.

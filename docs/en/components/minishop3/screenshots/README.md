...
| --- | --- | --- |
| `mgr-orders.png` | **Extras → MiniShop3 → Orders**: list, drafts toggle | [interface/orders.md](../interface/orders.md) |
...
| `mgr-category-products.png` | Category resource product table (option columns) | [interface/category.md](../interface/category.md), [quick-start.md](../quick-start.md) |

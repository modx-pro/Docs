...
Put PNG files in this folder. Markdown already references `/components/minishop3/screenshots/filename.png` (stubs without files). After you add PNGs, no text edits are required.

| File | What to capture | Used in |
| --- | --- | --- |
| `mgr-orders.png` | **Extras → MiniShop3 → Orders**: list, drafts toggle | [interface/index.md](../interface/index.md) |
| `mgr-order.png` | Order card (tabs, recalculate cost) | [interface/index.md](../interface/index.md) |
| `mgr-customers.png` | **Extras → MiniShop3 → Customers** | [interface/index.md](../interface/index.md) |
...
| `mgr-option-groups.png` | Option groups DnD (`msOptionGroup`) | [interface/settings/options.md](../interface/settings/options.md) |
...
| `mgr-extra-fields.png` | **Utilities → Extra fields** (incl. repeater / key-value) | [interface/utilities/extra-fields.md](../interface/utilities/extra-fields.md) |
| `mgr-grid-columns.png` | **Utilities → Grid columns** | [interface/utilities/grid-columns.md](../interface/utilities/grid-columns.md) |
| `mgr-category-products.png` | Category products grid (option columns) | [interface/category.md](../interface/category.md) |
| `mgr-product-gallery.png` | Product gallery tab | [interface/gallery.md](../interface/gallery.md) |
| `mgr-product-categories.png` | **Categories** tab on the product | [interface/product.md](../interface/product.md) |

...
<!-- TODO: translate from docs/components/msreviews/frontend/product.md -->
...
Для длинных списков отзывов и Q&A оберните `msReviews` / `msQuestions` в **`!pdoPage`**. Примеры: [Интеграция — пагинация](../integration#пагинация-pdopage).

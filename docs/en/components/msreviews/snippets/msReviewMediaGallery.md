...
UGC-блок на PDP: миниатюры фото покупателей. По умолчанию клик открывает **lightbox** (стрелки, счётчик, закрытие). С `reviewAnchor` ссылка ведёт к якорю отзыва на странице.

...
| Goal | Guide |
| --- | --- |
| Clone repo, PRs, `docs/` layout | [Getting Started](/en/guide/getting-started) |
| Headings, lists, code in Markdown | [Markdown](/en/guide/markdown) |
| Containers, line highlight, tabs | [VitePress Features](/en/guide/vitepress) |
| `title`, `description`, component menu | [Frontmatter](/en/guide/frontmatter) |
| Flowcharts and sequence diagrams | [Mermaid diagrams](/en/guide/mermaid) |
| Spell check before commit | [Spell checking (cspell)](/en/guide/cspell) |

## Questions and site issues

Use [GitHub Issues](https://github.com/modx-pro/Docs/issues) for discussions and bugs about the documentation project. Content changes go through the usual **Pull Request** workflow in the same repository.

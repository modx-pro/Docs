...
Прямо сейчас, на данной странице, в левом боковом меню вы видите список уже существующих категорий и если в их числе уже существует подходящая вам, то сразу переходите к изучению [следующего раздела](#pishem-gotovoe-reshenie).
...
Также не забудьте указать своё авторство следуя [следующим инструкциям](/guide/frontmatter#avtor-komponenta), добавив в начале файла свойство `author`.

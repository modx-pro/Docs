      ...
      { text: 'MinifyX', link: '/components/minifyx' },
      {
        ...
        items: [
          ...
          },
          {
            ...
            collapsed: true,
            items: [
              { text: 'aflCheckPassLength', link: '/components/minishop2/validators/aflcheckpasslength' },
              { text: 'aflPasswordConfirm', link: '/components/minishop2/validators/aflpasswordconfirm' },
              { text: 'aflRequiredIf', link: '/components/minishop2/validators/aflrequiredif' },
              { text: 'aflUserExists', link: '/components/minishop2/validators/afluserexists' },
              { text: 'aflUserNotExists', link: '/components/minishop2/validators/aflusernotexists' },
            ],
          },
        ],
      },

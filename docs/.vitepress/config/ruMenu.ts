...
export default<DefaultTheme.SidebarItem[]> [
  ...
  },
  {
    ...
    items: [
      ...
      {
        text: 'Провайдеры',
        link: '/components/hybridauth/providers/',
        collapsed: true,
        items: [
  ...
  { text: 'Яндекс.Деньги', link: '/components/yandex-money' },
  { text: 'Platron', link: '/components/platron' },
  { text: 'WebMoney', link: '/components/webmoney' },
  { text: 'msMerchant', link: '/components/msmerchant' },
  { text: 'mspUP', link: '/components/mspup' },
  { text: 'mspWebPay', link: '/components/mspwebpay' },
  { text: 'mspAssistBelarus', link: '/components/mspassistbelarus' },
  { text: 'mspPayU', link: '/components/msppayu' },
  { text: 'mspYaCassa', link: '/components/mspyacassa' },
  { text: 'mspPayAnyWay', link: '/components/msppayanyway' },
  { text: 'mspBePaid', link: '/components/mspbepaid' },
  { text: 'mspPayPal', link: '/components/msppaypal' },
  {
    text: 'RBK Money',
    link: '/components/rbk-money/',
    collapsed: true,
    items: [
      { text: 'Выбор способа оплаты на сайте', link: '/components/rbk-money/choosing-payment-method' },
    ],
  },
  {
    text: 'allGifts',
    link: '/components/allgifts/',
    collapsed: true,
    items: [
      { text: 'Быстрый старт', link: '/components/allgifts/quick-start' },
      { text: 'Решение проблем', link: '/components/allgifts/problem-solving' },
    ],
  },
  { text: 'ordersUnformed', link: '/components/ordersunformed' },
  { text: 'msAddLinked', link: '/components/msaddlinked' },
  { text: 'msBuyNow', link: '/components/msbuynow' },
  { text: 'msCategoryOptions', link: '/components/mscategoryoptions' },
  { text: 'msDaData', link: '/components/msdadata' },
  { text: 'msDellin', link: '/components/msdellin' },
  {
    text: 'msDiscount',
    link: '/components/msdiscount/',
    collapsed: true,
    items: [
      { text: 'Акции', link: '/components/msdiscount/stock' },
      { text: 'Скидки', link: '/components/msdiscount/discounts' },
      { text: 'Купоны', link: '/components/msdiscount/coupons' },
      {
        text: 'Сниппеты',
        items: [
          { text: 'msdBuyNow', link: '/components/msdiscount/snippets/msdbuynow' },
          { text: 'msdGetDiscount', link: '/components/msdiscount/snippets/msdgetdiscount' },
        ],
      },
    ],
  },
  { text: 'msEMS', link: '/components/msems' },
  { text: 'mscDistance', link: '/components/mscdistance' },
  { text: 'ms2form', link: '/components/ms2form' },
  { text: 'msLiveInform', link: '/components/msliveinform' },
  { text: 'msManagerOrderMap', link: '/components/msmanagerordermap' },
  { text: 'msNewPrice', link: '/components/msnewprice' },
  { text: 'msMCD', link: '/components/msmcd' },
  { text: 'msSalePrice', link: '/components/mssaleprice' },
  { text: 'msSMS', link: '/components/mssms' },
  { text: 'msOneClick', link: '/components/msoneclick' },
  { text: 'msOptionsPrice', link: '/components/msoptionsprice' },
  {
    text: 'msProfile',
    collapsed: true,
    items: [
      { text: 'Интерфейс', link: '/components/msprofile/interface' },
      {
        text: 'Сниппеты',
        collapsed: true,
        items: [
          { text: 'msProfile', link: '/components/msprofile/snippets/msprofile' },
          { text: 'msProfileCharge', link: '/components/msprofile/snippets/msprofilecharge' },
        ],
      },
      { text: 'Плагин', link: '/components/msprofile/plugin' },
    ],
  },
  {
    text: 'msPointsIssue',
    collapsed: true,
    link: '/components/mspointsissue/',
    items: [
      {
        text: 'Сниппеты',
        link: '/components/mspointsissue/snippets/',
        collapsed: true,
        items: [
          { text: 'msPointsIssue.Order', link: '/components/mspointsissue/snippets/mspointsissue-order' },
        ],
      },
      {
        text: 'Интерфейс',
        link: '/components/mspointsissue/interface/',
        collapsed: true,
        items: [
          { text: 'Заказы', link: '/components/mspointsissue/interface/orders' },
          { text: 'Настройка', link: '/components/mspointsissue/interface/settings' },
        ],
      },
    ],
  },
  {
    ...
    link: '/components/msproductremains/',
    collapsed: true,
    items: [
      { text: 'Настройки компонента', link: '/components/msproductremains/settings' },
      { text: 'Вкладка остатков', link: '/components/msproductremains/remains-tab' },
      { text: 'Страница остатков', link: '/components/msproductremains/remains-page' },
      { text: 'Сниппет getRemains', link: '/components/msproductremains/getremains' },
      { text: 'Примеры', link: '/components/msproductremains/examples' },
    ],
  },
  { text: 'msQuickView', link: '/components/msquickview' },
  {
    text: 'msBonus2',
    link: '/components/msbonus2/',
    collapsed: true,
    items: [
      { text: 'Быстрый старт', link: '/components/msbonus2/quick-start' },
      {
        text: 'Сниппеты',
        collapsed: true,
        items: [
          { text: 'msBonus2Form', link: '/components/msbonus2/snippets/msbonus2form' },
          { text: 'msBonus2Logs', link: '/components/msbonus2/snippets/msbonus2logs' },
          { text: 'msBonus2ProductBonus', link: '/components/msbonus2/snippets/msbonus2productbonus' },
        ],
      },
      { text: 'События jQuery', link: '/components/msbonus2/jquery-events' },
      {
        text: 'События плагинов',
        collapsed: true,
        items: [
          { text: 'msb2OnBeforeSetBonus', link: '/components/msbonus2/events/msb2onbeforesetbonus' },
          { text: 'msb2OnSetBonus', link: '/components/msbonus2/events/msb2onsetbonus' },
          { text: 'msb2OnUnsetBonus', link: '/components/msbonus2/events/msb2onunsetbonus' },
          { text: 'Примеры', link: '/components/msbonus2/events/examples' },
        ],
      },
      { text: 'Программное API', link: '/components/msbonus2/api' },
      {
        text: 'Кейсы',
        collapsed: true,
        items: [
          { text: 'Вывод информации в письме о списанных бонусах за заказ', link: '/components/msbonus2/cases/email-inform' },
          { text: 'Дополнительные бонусы за первый заказ на сайте', link: '/components/msbonus2/cases/additional-bonuses' },
          { text: 'Применять либо промокод msPromoCode2, либо бонусы msBonus2', link: '/components/msbonus2/cases/mspromocode2-or-msbonus2' },
        ],
      },
    ],
  },
  { text: 'msSetInCart', link: '/components/mssetincart' },
  { text: 'msYmarket', link: '/components/msymarket' },
  {
    text: 'msPromoCode',
    link: '/components/mspromocode/',
    collapsed: true,
    items: [
      {
        text: 'Функционал',
        collapsed: true,
        items: [
          { text: 'Акции', link: '/components/mspromocode/functionality/stocks' },
          { text: 'Условия применения', link: '/components/mspromocode/functionality/conditions' },
          { text: 'Реферальные промо-коды', link: '/components/mspromocode/functionality/referral-promo-codes' },
          { text: 'Фиксированная скидка на всю корзину', link: '/components/mspromocode/functionality/fixed-cart-discount' },
        ],
      },
      { text: 'Установка и настройка', link: '/components/mspromocode/setup' },
      {
        text: 'Сниппеты',
        collapsed: true,
        items: [
          { text: 'mspcForm', link: '/components/mspromocode/snippets/mspcform' },
          { text: 'mspcRefCoupon', link: '/components/mspromocode/snippets/mspcrefcoupon' },
        ],
      },
      { text: 'jQuery события', link: '/components/mspromocode/jquery-events' },
      {
        text: 'События плагинов',
        link: '/components/mspromocode/events/',
        collapsed: true,
        items: [
          { text: 'mspcOnBeforeSetCoupon', link: '/components/mspromocode/events/mspconbeforesetcoupon' },
          { text: 'mspcOnSetCoupon', link: '/components/mspromocode/events/mspconsetcoupon' },
          { text: 'mspcOnBeforeSetProductDiscount', link: '/components/mspromocode/events/mspconbeforesetproductdiscount' },
          { text: 'mspcOnSetProductDiscount', link: '/components/mspromocode/events/mspconsetproductdiscount' },
          { text: 'mspcOnBindCouponToOrder', link: '/components/mspromocode/events/mspconbindcoupontoorder' },
        ],
      },
      {
        text: 'Кейсы',
        link: '/components/mspromocode/cases/',
        collapsed: true,
        items: [
          { text: 'Вывод информации по промо-коду в письме', link: '/components/mspromocode/cases/email-inform' },
          { text: 'Именные промокоды для пользователя', link: '/components/mspromocode/cases/personalized-promo-codes' },
          { text: 'Отменить промо-код при наличии в корзине запрещённых товаров', link: '/components/mspromocode/cases/cancel-promo-code' },
        ],
      },
    ],
  },
  {
    text: 'msPromoCode2',
    link: '/components/mspromocode2/',
    collapsed: true,
    items: [
      { text: 'Быстрый старт', link: '/components/mspromocode2/quick-start' },
      {
        text: 'Сниппеты',
        collapsed: true,
        items: [
          { text: 'msPromoCode2', link: '/components/mspromocode2/snippets/mspromocode2' },
          { text: 'mspc2Generate', link: '/components/mspromocode2/snippets/mspc2generate' },
          { text: 'mspc2CartKey', link: '/components/mspromocode2/snippets/mspc2cartkey' },
        ],
      },
      { text: 'События jQuery', link: '/components/mspromocode2/jquery-events' },
      {
        text: 'События плагинов',
        link: '/components/mspromocode2/events/',
        collapsed: true,
        items: [
          { text: 'mspc2OnBeforeGetCoupon', link: '/components/mspromocode2/events/mspc2onbeforegetcoupon' },
          { text: 'mspc2OnGetCoupon', link: '/components/mspromocode2/events/mspc2ongetcoupon' },
          { text: 'mspc2OnBeforeSetCoupon', link: '/components/mspromocode2/events/mspc2onbeforesetcoupon' },
          { text: 'mspc2OnSetCoupon', link: '/components/mspromocode2/events/mspc2onsetcoupon' },
          { text: 'mspc2OnUnsetCoupon', link: '/components/mspromocode2/events/mspc2onunsetcoupon' },
          { text: 'mspc2OnSetProductDiscountPrice', link: '/components/mspromocode2/events/mspc2onsetproductdiscountprice' },
          { text: 'Примеры', link: '/components/mspromocode2/events/examples' },
        ],
      },
      { text: 'Программное API', link: '/components/mspromocode2/api' },
      {
        text: 'Кейсы',
        link: '/components/mspromocode2/cases/',
        collapsed: true,
        items: [
          { text: 'Вывод информации по промо-коду в письме', link: '/components/mspromocode2/cases/email-inform' },
          { text: 'Установка промо-кода программно при входе на сайт', link: '/components/mspromocode2/cases/set-promocode' },
          { text: 'Генерация промо-кода в письме на следующий заказ', link: '/components/mspromocode2/cases/generate-promocode' },
          { text: 'Применять либо промокод msPromoCode2, либо бонусы msBonus2', link: '/components/mspromocode2/cases/mspromocode2-or-msbonus2' },
        ],
      },
    ],
  },
  { text: 'mscZone', link: '/components/msczone' },
  {
    text: 'mSearch2',
    collapsed: true,
    ...
    items: [
      {
        ...
        items: [
          ...
          { text: 'mSearchForm', link: '/components/msearch2/snippets/msearchform', },
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Пример фильтрации товаров', link: '/components/msearch2/extension/filtering-product-example', },
        ],
      },
      {
        ...
        collapsed: true,
        items: [
          { text: 'Зависимые фильтры', link: '/components/msearch2/solutions/dependent-filters', },
          { text: 'Фильтрация категорий', link: '/components/msearch2/solutions/category-filtering', },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    collapsed: true,
    items: [
      { text: 'msImportExport 1.0', link: '/components/msimportexport/msimportexport-1' },
      { text: 'msImportExport 2.0', link: '/components/msimportexport/msimportexport-2' },
    ],
  },
  {
    text: 'mSocial',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        collapsed: true,
        items: [
          { text: 'pdoTools', link: '/components/pdotools/classes/pdotools' },
          { text: 'pdoFetch', link: '/components/pdotools/classes/pdofetch' },
          { text: 'pdoParser', link: '/components/pdotools/classes/pdoparser' },
        ],
      },
      { text: 'Общие параметры', link: '/components/pdotools/general-properties' },

...
Наиболее быстрый и простой способ внесения небольших правок - сделать это прямо внутри [GitHub](https://github.com/modx-pro/Docs)

::: info
У Вас должен быть аккаунт GitHub (простейшая регистрация)
:::

Выберите необходимый вам файл для редактирования в каталоге `Docs/docs/components/`

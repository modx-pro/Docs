...
::: warning
Используя любой из способов установки, убедитесь, что вы выполняете Teleport под тем же пользователем, под которым работает PHP когда исполняется веб-сервером. В противном случае ваш MODX-сайт может быть повреждён путем инъекции и/или кэширования файлов с некорректным владельцем файлов.
:::
...
[6]: /system/utilities/teleport/usage

...
Выводит определенное количество символов с начала строки (значение по умолчанию - 100).
...
Добавляет многоточие и обрезает строку, если она длиннее, чем указанное количество символов (по умолчанию - 100).
...
Прибавляет указанное число (значение по умолчанию +1).
...
Вычитает указанное число (значение по умолчанию -1).
...
Умножает на указанное число (значение по умолчанию *2).
...
Делит на указанное число (значение по умолчанию /2).
...
Возвращает модуль числа (по умолчанию: %2, возвращает 0 или 1).

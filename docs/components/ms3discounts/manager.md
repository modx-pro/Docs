...
| В каталоге | включено | Показывать скидку в списке акций и подборке `ms3discountsBuyNow`. |
| В товаре | включено | Показывать скидку на карточке товара и в бейдже строки каталога. |

...
- **old_price** - старая стоимость товара, число до 2х знаков после запятой
...
- **remains** - количество товара в наличии, целое число
- **reserved** - количество зарезервированного товара, целое число

...
items: [
  ...
  },
  {
    ...
    items: [
      { text: 'Обзор SPA', link: 'interface/index' },
      { text: 'Мастер доступа', link: 'interface/wizard' },
      { text: 'Продукты, правила и группы', link: 'interface/products-and-rules' },
      { text: 'Ресурсы и premium blocks', link: 'interface/resources-and-blocks' },
      { text: 'Доступы, клиенты и промокоды', link: 'interface/accesses-and-clients' },
      { text: 'Журнал и настройки SPA', link: 'interface/index#журнал' },
    ],
  },
  {
    ...
    link: 'integration',
    items: [
      { text: 'Покупка через miniShop3', link: 'integration' },
      { text: 'Paywall на страницах', link: 'frontend/paywall' },
      { text: 'Защищённые файлы', link: 'frontend/protected-files' },
      { text: 'Личный кабинет', link: 'frontend/cabinet' },
      { text: 'CSS и чанки', link: 'frontend' },
      { text: 'Сниппеты (обзор)', link: 'snippets/index' },
      { text: 'PremiumAccess', link: 'snippets/PremiumAccess' },
      { text: 'PremiumAccessBuy', link: 'snippets/PremiumAccessBuy' },
      { text: 'PremiumAccessFile', link: 'snippets/PremiumAccessFile' },
      { text: 'PremiumAccessCabinet', link: 'snippets/PremiumAccessCabinet' },
      { text: 'PremiumAccessPromoRedeem', link: 'snippets/PremiumAccessPromoRedeem' },
      { text: 'PremiumAccessRenew', link: 'snippets/PremiumAccessRenew' },
      { text: 'PremiumAccessSubscription', link: 'snippets/PremiumAccessSubscription' },
    ],
  },
  {
    ...
    items: [
      ...
      { text: 'Connector API', link: 'development/api' },
    ],
  },
  { text: 'FAQ', link: 'faq' },
]

...
- Управление правами приложения. Возможность назначить права управления метками только определенным группам и контекстам. Шаблон политики доступа **userMarker**

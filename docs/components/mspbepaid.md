...
_**Важно!** В таблице ниже, для лучшей читаемости, ключи настроек представлены в коротком виде, без префикса **ms2_payment_bepaid_**._

| Описание                                                                                                                                                                                                                                                                                                        | Ключ                                                        | Значение по умолчанию |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------- | --------------------- |
| **Идентификатор магазина в системе bePaid**  Данный идентификатор создаётся при регистрации в системе bePaid и высылается в письме.                                                                                                                                                                             | store_id                                                    |                       |
| **Секретный ключ** Последовательность случайных символов, участвует в формировании электронной подписи заказа, выдаётся при регистрации магазина в системе bePaid.                                                                                                                                              | secret_key                                                  |                       |

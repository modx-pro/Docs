...
Пространство имён в MODX: `easyfavicon`. Кнопка «Системные настройки» на странице компонента открывает их сразу с фильтром по EasyFavicon.
...
| `easyfavicon.auto_inject_profile` | — | Имя или id профиля для автовставки; пусто — активный профиль контекста |
...
| `easyfavicon.interactive_url` | `https://realfavicongenerator.net/api/favicon_generator` | Адрес интерактивного API RealFaviconGenerator; менять не нужно |

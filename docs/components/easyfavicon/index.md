...
::: warning
Пакет зашифрован и ставится только через провайдер modstore.pro на сайт, для которого куплен. Архив, загруженный в Менеджер пакетов вручную, не установится.
:::

...
Во время скачивания изображения происходит автоматически перенос этих данных.
...
Для того чтобы определить что изображение уже было загружено в галерею сравниваются hash изображений в галерее с карточкой товара и с hash найденных изображений.

...
Эта кнопка запускает окно для поиска изображений по google картинкам и прямого скачивания в галерею minishop2 или ms2Gallery

Поиск производить только после прописания API ключа и Идентификатора поисковой системы
...
## Настройка и получение API ключа и Идентификатора системы

Для работы сервиса требуется получить API ключ и Идентификатора поиска.

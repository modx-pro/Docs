...
В диалоге задают товар, рейтинг 1–5, заголовок, текст, имя и email автора, статус и чекбокс **Verified purchase**.
...
- при смене **товара** при редактировании пересчитываются агрегаты старого и нового товара.
...
- **Редактировать** (карандаш): тот же диалог, что и «Добавить отзыв».

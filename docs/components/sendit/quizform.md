...
с которой проблематично работать. JSON в чанк передаётся невалидным, полагаю это связано с обработкой входящих данных с целью защиты от XSS атак, но его можно перевести в

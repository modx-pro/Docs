...
|---------|----------|----------|
| `data-pn-more` | Кнопка "Загрузить ещё" | Без значения |
| `data-pn-first` | Кнопка перехода на первую страницу | `1` |
| `data-pn-prev` | Кнопка перехода на предыдущую страницу | Без значения |
| `data-pn-next` | Кнопка перехода на следующую страницу | Без значения |
| `data-pn-last` | Кнопка перехода на последнюю страницу | Значение `$totalPages` |
| `data-pn-current` | Поле ввода номера страницы | Без значения |
| `data-pn-limit` | Поле ввода лимита | Без значения |
| `data-pn-total` | Блок отображения общего числа страниц | Без значения |
| `data-pn-type` | Тип пагинации: `classic` для навигации кнопками или `scroll` для добавления страниц при прокрутке | Без значения |

...
Используйте некэшированный вызов `[[!BannerPro]]` или `{'!BannerPro' | snippet : ...}`. Кэш готового HTML зависит от `bannerpro_cache`, `sortby` и параметров вызова (см. [Интеграция](../integration#кэш)).

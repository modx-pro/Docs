...
description: "Вывод BannerPro на сайте: чанки, ротация, кэш, клики, показы, лимиты, срок хранения"
---
...
Настройки `bannerpro_utm_*` добавляют UTM к URL баннера после клика. См. [Системные настройки](settings#utm-при-клике). UTM из настроек не перезаписывают query-параметры, уже указанные в URL баннера.

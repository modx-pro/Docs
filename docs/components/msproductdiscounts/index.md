...
* `[data-mspd-prop="old_price_str"]` - блок вывода отформатированной цены старой товара, если нужна неотформатированная старая цена укажите в качестве значения `old_price`.

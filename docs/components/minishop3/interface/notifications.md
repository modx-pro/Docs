...
<!-- ![Центр уведомлений](/components/minishop3/screenshots/mgr-notifications.png) -->
...
Известное поведение в текущей реализации канала: письмо может уйти на контакты `msCustomer`, а не на email из формы заказа.

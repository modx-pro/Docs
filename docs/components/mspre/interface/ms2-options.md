...
::: warning
Компонент работает только с базовыми Типами характеристик Опций, то есть те которые были добавлены при установке. Все остальные не будут отображаться в списке полей
:::
...
Поле **Новое значение** возможно будет ввести те значения что использует выбранный тип характеристики
...
::: danger
Тип поля Удалить значение зависит от типа выбранной характеристики для поля
...
Найдет все совпадения у выбранных товаров в опциях и удалит их.

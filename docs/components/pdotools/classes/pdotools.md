...
pdoTools можно подключить в своём сниппете только ради лога. У штатных сниппетов в 3.x тайминг после **&showLog**=`1` лежит в плейсхолдере, например `[[+pdoResourcesLog]]`. См. [параметр showLog](../general-properties#showlog).

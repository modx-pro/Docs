...
:::tip
Поля для фильтрации можно искать по ключу или по названию. Чтобы сопоставить ключу название добавьте соответствующую запись словаря в пространство имён **flatfilters** в тему **default** в формате

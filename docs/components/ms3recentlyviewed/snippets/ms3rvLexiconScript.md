...
Выводит на страницу скрипт с лексиконом и конфигом для фронтенда. В `window.ms3rvLexicon` и `window.ms3rvConfig` подставляются язык сайта и значение настройки **max_items**.

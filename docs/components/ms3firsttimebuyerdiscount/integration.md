...
Важно: доступность этих полей в API-ответе зависит от реализации MiniShop3 (мерджит ли она `returnedValues` в payload конкретного метода).
...
- для гостей показывает плашку оптимистично (до ввода email/phone)

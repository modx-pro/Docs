...
Блок «Нам доверяют»: логотипы в CSS-сетке. У каждого лого alt для доступности.
...
- Ссылки на сайты партнёров в этой секции нет — см. [Ряд брендов](brands_row), если нужен кликабельный логотип
...
Repeater **Логотипы**: изображение и alt. Держите одинаковую высоту логотипов в макете.

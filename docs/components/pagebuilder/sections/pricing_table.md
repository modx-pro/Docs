...
- **SaaS** — три тарифа на странице цен
...
Repeater **Тарифы**. Поле **Список возможностей** — plain text, **одна строка = один пункт**. Кнопку тарифа задайте через поля кнопки в строке.

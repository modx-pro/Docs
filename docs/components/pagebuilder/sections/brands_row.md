...
Поиск категории идёт в `mgr/ms3/categories/search`. **Источник** по умолчанию `manual` (repeater) или **Бренды из категории** (`category_vendors`). Для `category_vendors` укажите **Родительскую категорию**. Пустой `limit` при автоматическом списке в enrich становится 12.
...
Тип [select](../fields/select#vyvod-v-section-data). Необязательное. `manual` (значение по умолчанию) или `category_vendors`.

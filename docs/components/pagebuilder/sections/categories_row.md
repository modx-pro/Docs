...
- На главной каталога: вход в разделы
- На странице родительской категории: подкатегории
- На лендинге: витрина направлений
...
Поиск категории идёт в `mgr/ms3/categories/search`. **Родительская категория** обязательна. Пустой `limit` в chunk становится 8. Тип помечен `"cacheable": false`. В выборку попадают только ресурсы класса msCategory.

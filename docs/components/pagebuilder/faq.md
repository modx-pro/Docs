...
- Вы нажали **Опубликовать**? Сниппет читает `published_json`, не черновик.
...
Нужен transport **pagebuilderpro** и действующая лицензия Pro. Commerce-секции дополнительно требуют **miniShop3**.

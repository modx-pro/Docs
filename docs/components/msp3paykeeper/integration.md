...
Старое имя класса с маленькой k, `Msp3Paykeeper`, пакет по-прежнему подключает. На диске, где регистр букв в имени файла не различается, это срабатывает, только если новый класс ещё не загружен под вторым именем.

...
На публичном демо-стенде готового секретного слова в документации нет. Его задают в кабинете этого стенда. Без слова webhook не проверить. Счёт при этом уже создаётся.

...
Иногда поле есть в конфигурации, но не видно на странице — оно вырезано из вёрстки (`data-mpc-remove`) или вспомогательное. Такие поля всё равно можно править двумя путями:

- **кнопка-триггер у блока** на странице открывает панель скрытых полей этого блока;

...
- **Индекс фасетов** — денормализованный индекс для каталогов 100k+ товаров; фильтрация за 1–2 секунды независимо от размера. Автосинхронизация после правок через админку, MS3 ImportCSV и API ([подробнее](interface/maintenance))
...
1. Перейдите в **Установщик**
2. Нажмите **Загрузить дополнения**
3. Найдите **mFilter** в списке
4. Нажмите **Загрузить**, затем **Установить**
...
В админке **Установщик → mFilter → Наборы фильтров**:

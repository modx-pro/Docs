...
::: tip Нужен текст под одну конкретную подборку
Шаблон описывает правило для всех значений фильтра сразу. Если под отдельную страницу написан свой текст, его задают на вкладке [Индивидуальные SEO](seo-pages) — заполненные там поля перекрывают шаблон, незаполненные продолжают браться из него.
:::

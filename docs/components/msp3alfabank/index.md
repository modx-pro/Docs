...
- [Быстрый старт](quick-start): провайдер modstore, логин из письма, тестовый и боевой шлюз.
- [Системные настройки](settings): логин, пароль, адрес шлюза, валюта, URL возврата.
- [Интеграция и сценарии](integration): статусы банка, вкладка заказа, переход с `mspAlfaBank`.

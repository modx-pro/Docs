...
title: Сниппеты
---
# Сниппеты ms3Favorites

Компонент предоставляет девять сниппетов для вывода блока избранного, кнопки, счётчика, страницы и лексикона для фронтенда.

- [ms3Favorites](ms3Favorites) — вывод списка товаров/ресурсов по переданным ID

...
| `ms3favorites.max_lists` | Максимум списков на пользователя | `10` | Лимит именованных списков (`default`, `gifts`, `plans` и др.). Сервер допускает до 20. `favorites.js` не создаст больше 10 списков. |

...
items: [
  { text: 'Подробное описание', link: 'description' },
...
Компонент можно использовать на любых страницах сайта, например в карточках товара или на странице О компании.

Отличительной особенностью easyComm является встроенная поддержка пользовательских оценок, которые позволяют при создании отзывов оценить что-либо по указанной шкале (напр. от 1 до 5), а в дальнейшем вывести средний рейтинг.

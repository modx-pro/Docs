...
**Общие → Режим разработки** — усиливает детализацию в логах. Для отладки на **витрине** см. также `mxdadata_debug_mode` и `?mxdadata_debug=1` в [Интеграции](integration#отладка-на-витрине).

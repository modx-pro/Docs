...
**Проверка админки:** откройте **Extras → mxDadata**. Без **VueTools** интерфейс менеджера может быть недоступен; сниппеты на сайте работают независимо.
...
2. Должны появиться подсказки DaData; после выбора — заполнение города, индекса, FIAS (если настроено в форме)

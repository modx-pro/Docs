...
Три веб-сниппета для подсказок DaData в браузере. Все используют **`connector-web.php`** и при необходимости общий CSS подсказок.

| Сниппет | Назначение |
|---------|------------|
| [mxDadataAddressSuggest](mxDadataAddressSuggest) | Подсказки адреса, заполнение полей города, индекса, FIAS |
...
Вызовы в типичном сценарии **мини-шоп** — **некэшированные** (`[[!…]]` или `!` в Fenom).

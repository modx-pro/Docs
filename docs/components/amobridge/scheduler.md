...
2. Включите настройку **amobridge.use_scheduler**
...
|--------|------|----------|
| `amobridge_new_order` | `tasks/sendNewOrder.php` | Отправка нового заказа |
| `amobridge_order_status` | `tasks/sendOrderStatus.php` | Смена статуса заказа |
| `amobridge_form_submission` | `tasks/sendFormSubmission.php` | Отправка данных формы |

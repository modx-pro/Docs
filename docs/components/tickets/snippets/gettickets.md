...
Выводит список тикетов.

**Вызывайте некэшированным.** Счётчик комментариев в чанке может ссылаться на `#first_unread`.
...
| **&tplWrapper**      |                        | Обёртка всего вывода; в чанке плейсхолдер output                                                                                                                       |

...
Пользователи фронтенда должны входить в группу с политикой `TicketUserPolicy` в контексте `web`. Таблица всех ключей: [Политики и права](permissions).
...
Добавляйте новых пользователей в группу Member (или свою). Для регистрации на сайте удобен [HybridAuth][1].

...
```
backlog  →  to_start  →   plan    →  confirm  →  in_progress  →  review   →   done
 старт       автор      исполнитель    автор      исполнитель   исполнитель   автор
           (открыл)       (план)     (одобрил)     (в работе)      (сдал)    (закрыл)
```

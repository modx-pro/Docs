...
### Пример оформления чанка **&tplActivate**

```
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" lang="[[++cultureKey]]">
  <head>
    <base href="[[++site_url]]" />
    ...
    <style>
      ...
      **********************************************/
      ...
      table,tr,td{vertical-align:top;text-align:left;padding:0;}
      hr{color:#d9d9d9;background-color:#d9d9d9;height:1px;border:none;}
      table.body{height:100%;width:100%;}
      table.container{width:580px;text-align:inherit;margin:0 auto;}
      table.row{width:100%;position:relative;padding:0;}
      table.container table.row{display:block;}
      td.wrapper{position:relative;padding:10px 20px 0 0;}
      ...
      body,table.body,h1,h2,h3,h4,h5,h6,p,td{color:#222;font-family:Helvetica, Arial, sans-serif;font-weight:400;text-align:left;line-height:1.3;margin:0;padding:0;}
      ...
      table.secondary td{background:#e9e9e9;color:#555;border-color:#d0d0d0;}
      ...
      .ExternalClass,.body .columns td.twelve,.body .column td.twelve,.sub-grid table{width:100%;}
      table.columns td.sub-columns,table.column td.sub-columns,table.columns td.sub-column,table.column td.sub-column,table.columns .right-text-pad,table.columns .text-pad-right,table.column .right-text-pad,table.column .text-pad-right{padding-right:10px;}
      table.center,td.center,h1.center,h2.center,h3.center,h4.center,h5.center,h6.center{text-align:center;}
      h5,table.large-button td a{font-size:24px;}
      h6,table.medium-button td a{font-size:20px;}
      a:hover,a:active{color:#2795b6!important;}
      a:visited,h1 a:active,h2 a:active,h3 a:active,h4 a:active,h5 a:active,h6 a:active,h1 a:visited,h2 a:visited,h3 a:visited,h4 a:visited,h5 a:visited,h6 a:visited{color:#2ba6cb!important;}
      table.button:hover td,table.button:visited td,table.button:active td,table.button:hover td,table.tiny-button:hover td,table.small-button:hover td,table.medium-button:hover td,table.large-button:hover td{background:#2795b6!important;}
      ...
      table[class=body] table.columns td,table[class=body] table.column td,table[class=body] .columns td.twelve,table[class=body] .column td.twelve{width:100%!important;}
      }
    </style>
    <style>
      .callout .wrapper{padding-bottom:20px;}
      .callout .panel{background:#ECF8FF;border-color:#b9e5ff;}
      .header{background:#999;}
      .footer .wrapper{background:#ebebeb;}
      .footer h5{padding-bottom:10px;}
      table.columns .text-pad{padding-left:10px;padding-right:10px;}
      table.columns .left-text-pad{padding-left:10px;}
      table.columns .right-text-pad{padding-right:10px;}
      @media only screen and (max-width: 600px) {
                            ...
                            <tr>
                              ...
                              <td class="six sub-columns last" style="text-align:right; vertical-align:middle;">
                                [[pdoMenu? 
                                  ...
                                  &hereClass=`0` 
                                  &scheme=`full` 
                                  &tpl=`@INLINE <a [[+attributes]] href="[[+link]]" [[+classes]] style="text-decoration: none; color: #3e454c;">[[+menutitle]]</a>[[+wrapper]]&nbsp;&nbsp;&nbsp;` 
                        ...
                        <table class="twelve columns">
                          <tr>
                            <td>
                              ...
                              <p class="lead">Ты пытаешься подписаться на рассылку с моего сайта.</p>
                              <p>В ней ты будешь получать новые подборки избранного и тд и тп.</p>
                            </td>
                            <td class="expander"></td>
                          </tr>
                        </table>
                    ...
                    <tr>
                      <td class="wrapper last">
                        <table class="twelve columns">
                          <tr>
                            <td class="panel">
                              <p>Для получения рассылки тебе необходимо ее подтвердить: <a href="[[+link]]">[[%sendex_btn_subscribe]]</a></p>
                            </td>
                            <td class="expander"></td>
                          </tr>
                        </table>
                      ...
                      <td class="wrapper last">
                        <table class="twelve columns">
                          <tr>
                            <td align="center">
                              <center>
                                <p style="text-align:center;"><a href="[[++site_url]]">Главная</a> | <a href="[[~1]]">Правила</a></p>
                              </center>
                            </td>
                            <td class="expander"></td>
                          </tr>

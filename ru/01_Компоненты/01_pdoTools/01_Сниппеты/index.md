...
**&includeParents** | Добавляет родителей в условие выборки. |
...
Название | Описание | По умолчанию
---|---|---
**&return** | Определяет способ вывода результiатов. chunks - шаблонирование, data - вывод значений полей, sql - вывод SQL-запроса, ids - идентификаторы через запятую | chunks

...
**&ajaxMode**			|  				| Включение встроенной ajax пагинации. См. ниже.
**&ajaxHistory**		|  				| Сохранение номера страницы в url при работе в режиме ajax. См. ниже.
...
Для примера укажет такой параметр:
```
[[!pdoPage?
    &parents=`0`

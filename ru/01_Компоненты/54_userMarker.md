...
* Возможность вывода отмеченых ресурсов пользователя через сниппет ***[[!userMarker.Resource? &label=`Проверен`]]*** с указанием нужной метки(вернет список id ресурсов)
...
Вывод списка ресурсов. В resources вставляем сниппет userMarker.Resource.

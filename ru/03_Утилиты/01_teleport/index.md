...
Как вариат, вы можете установить Teleport из исходников с использованием [Composer'а](http://getcomposer.org/). Изучите больше об использовании [git clone](https://github.com/modxcms/teleport/tree/master/doc/doc/install/git-clone.md) или [release archive](https://github.com/modxcms/teleport/tree/master/doc/doc/install/releases.md).
...
Более подробно [Teleport Профили](https://github.com/modxcms/teleport/tree/master/doc/use/profile.md).
...
Читайте подробнее о действии [Teleport Извлечения](https://github.com/modxcms/teleport/tree/master/doc/use/extract.md).
...
Читайте подробнее о действии [Teleport Инъекции](https://github.com/modxcms/teleport/tree/master/doc/use/inject.md).
...
Читайте подробнее о действии [Teleport СозданиеПользователя](https://github.com/modxcms/teleport/tree/master/doc/use/user-create.md).
